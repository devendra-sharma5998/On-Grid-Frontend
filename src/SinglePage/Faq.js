      ...
      <section className="faq">
        <div className="container">
          ...
          <div className="question" >
            <h2>What is background verification (BGV)?</h2>
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>What is the potential impact of not doing background verification?</h2>
...
According to a 2014 survey, a wrong hire can single-handedly bring down the team productivity by 15% and can cause negative financial impact accounting for 10 times the cost to the company (CTC).
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>How can we start BGV of our employees?</h2>
...
Bulk data format shared by the client
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>How much time does it take for BGV process to complete?</h2>
...
Some verifications that are dependent on a third party may take longer, and it can go to 5-10 working days. These include education record (some universities and institutes), prior employment verification, letter-based address verification.
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>What checks can be conducted under BGV? Do you have fixed packages, or can we customize the checks as per our requirement?</h2>
...
Your point of contact from OnGrid would also suggest the right set of checks for you, depending on industry and candidate profile, that will help you with both risk mitigation as well as compliance.
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>Can the candidate register directly and upload data, documents and consent for BGV?</h2>
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>Are documents required for BGV? Are scans good enough? How are documents collected for BGV?</h2>
...
Email from client user to OnGrid operations team.
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>Candidate has not submitted complete information or documents. How can you help us?</h2>
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>We want to verify our customers? Can we do that?</h2>
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>What are the information security and privacy measures that OnGrid has in place?</h2>
...
While enhancing data security and privacy is always a work in progress, we do welcome your suggestions on the same. Please write to us at partner@ongrid.in if you would like to help us enhance our data security and privacy policies, procedures and technical controls.
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>How can we take consent from the candidates who go through BGV?</h2>
...
Consent is key to privacy adherence, and we recommend that the consent must be wilful, and follow the principles of purpose limitation. If possible, take the consent in the local language as well, in addition to English.
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>I have a question which is not mentioned here. How do I reach out?</h2>
...
<div className="container">
          {/* Question */}
          <div className="question" >
            <h2>I got a registration link from OnGrid, what needs to be done?</h2>
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>I got a digital address verification link from OnGrid, what needs to be done?</h2>
...
Bulk data format shared by the client
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>How does OnGrid protect my data and documents?</h2>
...
While enhancing data security and privacy is always a work in progress, we do welcome your suggestions on the same. Please write to us at partner@ongrid.in if you would like to help us enhance our data security and privacy policies, procedures, and technical controls.
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2>My record is on OnGrid. I want to edit or delete it. How do I go about doing it?</h2>
        ...
        <div className="container">
          {/* Question */}
          <div className="question" >
            <h2> 6. I have a question which is not mentioned here. How do I reach out?</h2>
