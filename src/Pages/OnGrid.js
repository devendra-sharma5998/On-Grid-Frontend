...
const OnGrid = () => {
  ...
  const [changeImages] = useState([
    whyOngridWaiter,
    whyOngridFactoryWorker,
    whyOngridConstructorWaiter,
  ]);
  const [changeImages2] = useState([
    SecurityGuards,
    houseKeeping,
    whyOngridArchitect,
  ]);
  const [changeImages3] = useState([
    whyOngridTaxiDriver,
    whyOngridCashier,
    whyOngridEngineer,
  ]);
            ...
            <div className="mainGrid">
              <div id="Gridbox" className=" box1">
                <img
                  ...
                  style={{ width: "33px", verticalAlign: "middle" }}
                  alt="404"
                />
                <br />
          ...
          <img src="https://ongrid.in/images/home/whyOngridWaiter.jpg" alt='404 error' id='image3'/> */}
              ...
              <div id="Gridbox" className=" box8">
                ...
                <ul className="customBullets">
                  ...
                  <li>
                    Intuitive portal access for real time verification updates
                  </li>
                  <li>
                  ...
                  <li>
                    APIs for integrating with onboarding systems and HRMS 12X6
                    email and call support
                  </li>
                </ul>
              </div>
              <div id="Gridbox" className={state[item]}>
